...
sed -i 's/OPENSTACK_KEYSTONE_URL = "http://%s:5000/v2" % OPENSTACK_HOST/OPENSTACK_KEYSTONE_URL = "http://%s:5000/v3" % OPENSTACK_HOST/g' /etc/openstack-dashboard/local_settings.py
